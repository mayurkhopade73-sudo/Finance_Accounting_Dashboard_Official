  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold text-white-800">Opportunities</h1><p className="text-gray-500 text-sm mt-1">Track sales pipeline and opportunities</p></div>
